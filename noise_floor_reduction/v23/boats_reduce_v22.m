...
%         size(localdate)
    ...
    write_detection_kml_folders_v22g(id,cellstr(id_key),coords,eeznames,fmznames,mpanames,latgring,longring,doCoverage,~strictFlag,FILLVALUE,kmlfile,flist,dnblist,boats_version);    
end
