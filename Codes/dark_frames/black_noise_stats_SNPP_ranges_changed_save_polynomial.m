...
dnbfile = 'Data/for_antor/2022/SVDNB_npp_d20220708_t1341509_e1343133_b55419_c20220708151053453043_oeac_ops.h5';
...
%% Update csv file
opts = detectImportOptions('polynomials_4.csv','NumHeaderLines',0);
output = readtable('polynomials_4.csv', opts);
disp(output)
...
row = {dnbfile(size(dnbfile,1)), YMD, name(4), name(5), id, degree, coeff, 0};
output = [output; row];
writetable(output, 'polynomials_4.csv') 
