%%
function [] = multiple_h5_smi_and_steps_mark_spikes_11()
    SMI = 0.2;
    ...
    for i = 1:n
        ...
        disp(size(goodrange))
        disp(size(goodrange_2))
        disp(size(goodrange_3))
        ...
        row = {filename_2(size(filename_2,1)), YMD, name(4), name(5), id, degree, coeff, 0};
        output = [output; row];
        %disp(row)
