...
ranges = zeros(2,64);
ranges(:,1) = [4063 - aggrSNPP(1,4) + 1, 4063];
...
dnbfile = 'Data/for_antor/june2022_anomaly/SVDNB_npp_d20220627_t1208238_e1209480_b55262_c20220627133759055578_oebc_ops.h5';
...
%b = 4063;
trimmed_range = a:b;
%trimmed_range = 1:4063;

p = polyfit(double(trimmed_range),dnbvar(trimmed_range)',degree);
...
af3(:,b:4063) = 0;      % do not detect boats at the outskirts
