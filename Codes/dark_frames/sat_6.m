...
function [p_1] = sat_6()
    ...
    for j = 1:n
        ...
        p_2 = polyfit(double(goodrange_2),dnbvar_2(goodrange_3)',degree);
        ...
        for i = 2:(degree+1)
            coeff = strcat(coeff, string(p_2(i)), "; ");
        end
        ...
        p_1 = polyfit(double(goodrange_2),dnbvar_1(goodrange_2)',degree);
        
        sigmanoiseSNPP_1 = polyval(p_1,1:4063);
        
        %%
        %%
        SCALE = 1;
        af3_1 = single(wiener2(dnbdata_1,[3 3],SCALE*sigmanoiseSNPP_1));
        af3_2 = single(wiener2(dnbdata_2,[3 3],SCALE*sigmanoiseSNPP_2));
        
        %% Find SMI spikes
        
        % without spikes
        imgmed = medfilt2(af3_1,[3 3]);
        imgfiltSNPP = (af3_1 - imgmed);
