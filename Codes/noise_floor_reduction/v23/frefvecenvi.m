function [p,t,refmat] = frefvecenvi(fname)
%
% frefvecenvi          	- read envi image geolocation metadata
%
% SYNTAX
%
% [image,p,t]=frefvecenvi(fname)
%
% INPUT :
%
...
disp(['Opening "',fname,'"']);
disp([num2str(p(1)),' cols x ',num2str(p(2)),' lines x ',num2str(p(3)),' bands']);
